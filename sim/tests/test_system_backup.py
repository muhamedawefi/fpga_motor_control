...
async def run_system(dut):
    ...
    for cycle in range(300000):
        ...
        v_cmd_raw = dut.v_cmd_test.value.integer
        ...
        # FEEDBACK TO DUT
        # =========================
        dut.sim_current_ma.value = int(i_plant * CURRENT_SCALE)
    ...
    cocotb.log.error("\n" + "=" * 80)
    cocotb.log.error("FINAL METAVALUE CHECK AFTER SIMULATION")
    cocotb.log.error("=" * 80)
